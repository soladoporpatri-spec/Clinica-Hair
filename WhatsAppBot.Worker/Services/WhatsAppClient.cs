...
public class WhatsAppClient
{
    ...
    public async Task<PollResponse?> SendPollAsync(string bridgeUrl, string phone, string question, IEnumerable<PollOption> options, CancellationToken cancellationToken = default)
    {
        ...
        // Mantem o mesmo identificador em todas as tentativas HTTP. Se a Bridge enviar
        // a enquete mas a resposta se perder, o retry recupera o resultado anterior em
        // vez de criar uma segunda enquete no WhatsApp.
