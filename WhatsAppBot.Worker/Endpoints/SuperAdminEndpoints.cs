...
public static class SuperAdminEndpoints
{
    ...
    internal static List<ServicoItem> BuildDefaultServicos(int storeId, BusinessType type) =>
        type switch
        {
            ...
            {
                new() { StoreId = storeId, Nome = "Diagnostico remoto",          DuracaoMinutos = 30,  Preco = 50m,  Ativo = true, Ordem = 1 },
                new() { StoreId = storeId, Nome = "Otimizacao geral do Windows", DuracaoMinutos = 60,  Preco = 100m, Ativo = true, Ordem = 2 },
                new() { StoreId = storeId, Nome = "Otimizacao gamer e FPS",      DuracaoMinutos = 90,  Preco = 150m, Ativo = true, Ordem = 3 },
                new() { StoreId = storeId, Nome = "Otimizacao completa Premium", DuracaoMinutos = 120, Preco = 220m, Ativo = true, Ordem = 4 },
            },
